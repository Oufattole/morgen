...
def format_trajectory_batch(
    ...
    for i in range(batch_size):
        ...
        for code_idx in generated_code_indices[i]:
            ...
            code_info = code_information.get(code_idx.item(), CodeInformation("NONCODE", 0, None))
            code = code_info.code
...
def format_trajectories(
    ...
    If the dataset yields invalid code information, an error will be thrown:
        ...
        >>> with patch("morgen.generation.format_trajectories.get_code_information") as mock:
